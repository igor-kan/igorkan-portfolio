...
const projectsData: Project[] = [
  // === FEATURED ===
  { id: 1, title: 'Citizenship Canada Test', description: 'Interactive study guide and mock exam platform for the Canadian Citizenship test with full question bank.', category: 'Education', techStack: ['Next.js', 'TypeScript', 'Tailwind'], liveUrl: 'https://citizenship-canada-test-onm8k2wcr-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/citizenship-canada-test', featured: true, gradient: 'from-red-600 to-red-900' },
  { id: 2, title: 'MathQuest', description: 'Gamified math learning platform with interactive challenges and progress tracking.', category: 'Education', techStack: ['Next.js', 'TypeScript', 'Tailwind'], liveUrl: 'https://mathquest-kudjjz0by-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/mathquest', featured: true, gradient: 'from-blue-600 to-purple-800' },
  { id: 3, title: 'FinsagE — AI Finance', description: 'AI-powered personal finance and smart money management platform with budget insights.', category: 'Finance', techStack: ['Next.js', 'React', 'AI'], liveUrl: 'https://finsage-smart-money-oixqijw73-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/finsage-smart-money-ai', featured: true, gradient: 'from-emerald-600 to-teal-900' },
  { id: 4, title: 'ThinkCraft Platform', description: 'Collaborative knowledge and learning platform for structured thinking and idea development.', category: 'Web Dev', techStack: ['Next.js', 'React', 'Tailwind'], liveUrl: 'https://thinkcraft-platform-e9z8t6wtb-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/thinkcraft-platform', featured: true, gradient: 'from-violet-600 to-indigo-900' },
  { id: 5, title: 'AIStylist', description: 'AI-powered wardrobe assistant that recommends outfits based on personal style and occasion.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'TypeScript'], liveUrl: 'https://aistylist-l2rx4efja-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/aistylist', featured: true, gradient: 'from-pink-600 to-rose-900' },
  { id: 6, title: 'Neuroflow', description: 'Mental wellness and cognitive enhancement app with guided exercises and progress analytics.', category: 'Health', techStack: ['Next.js', 'React', 'Tailwind'], liveUrl: 'https://neuroflow-eki6l3ain-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/neuroflow', featured: true, gradient: 'from-cyan-600 to-blue-900' },
  { id: 7, title: 'LedgerAI', description: 'AI-assisted accounting and financial ledger management for individuals and small businesses.', category: 'Finance', techStack: ['Next.js', 'AI', 'React'], liveUrl: 'https://ledgerai-2xkbmwv8h-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/ledgerai', featured: true, gradient: 'from-amber-600 to-orange-900' },
  { id: 8, title: 'Scholarly', description: 'Academic research organization and citation management tool for students and researchers.', category: 'Education', techStack: ['Next.js', 'TypeScript', 'React'], liveUrl: 'https://scholarly-lk94etdmb-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/scholarly', featured: true, gradient: 'from-slate-600 to-gray-900' },
  { id: 9, title: 'Skillattice', description: 'Skill mapping and career lattice platform for visualizing learning paths and competency gaps.', category: 'Web Dev', techStack: ['Next.js', 'React', 'D3.js'], liveUrl: 'https://skillattice-1frmkjqy4-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/skillattice', featured: true, gradient: 'from-lime-600 to-green-900' },
  { id: 10, title: 'Storyforge', description: 'AI-assisted creative writing and narrative design platform for authors and game designers.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'TypeScript'], liveUrl: 'https://storyforge-qsqha4of9-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/storyforge', featured: true, gradient: 'from-purple-600 to-violet-900' },

  // === AI / ML ===
  { id: 11, title: 'AI Grammar & Tone Fixer', description: 'Real-time grammar correction and writing tone adjustment powered by AI.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'React'], liveUrl: 'https://ai-grammar-tone-fixer-14098ec3p-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/ai-grammar-tone-fixer', featured: false, gradient: 'from-sky-500 to-blue-800' },
  { id: 12, title: 'AI Name & Logo Maker', description: 'AI-powered business name generator and instant logo design tool.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'Canvas'], liveUrl: 'https://ai-name-logo-maker-q2e66lov1-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/ai-name-logo-maker', featured: false, gradient: 'from-fuchsia-500 to-pink-800' },
  { id: 13, title: 'AI Resume Reviewer', description: 'AI-powered resume analysis with actionable feedback and ATS optimization suggestions.', category: 'AI/ML', techStack: ['HTML', 'CSS', 'JavaScript'], liveUrl: 'https://ai-resume-reviewer-a9ej8d1mm-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/ai-resume-reviewer', featured: false, gradient: 'from-teal-500 to-cyan-800' },
  { id: 14, title: 'AI Text Summarizer', description: 'Intelligent document summarization tool for articles, papers, and long-form content.', category: 'AI/ML', techStack: ['HTML', 'CSS', 'JavaScript'], liveUrl: 'https://ai-text-summarizer-p5kyxv6ps-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/ai-text-summarizer', featured: false, gradient: 'from-indigo-500 to-blue-800' },
  { id: 15, title: 'AI YouTube Optimizer', description: 'AI-powered YouTube title, thumbnail, and description optimizer for content creators.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'React'], liveUrl: 'https://ai-youtube-optimizer-gngpogg85-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/ai-youtube-optimizer', featured: false, gradient: 'from-red-500 to-rose-800' },
  { id: 16, title: 'Adgen', description: 'AI advertising copy generator for social media, display ads, and marketing campaigns.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'TypeScript'], liveUrl: 'https://adgen-m8bz8ugic-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/adgen', featured: false, gradient: 'from-orange-500 to-amber-800' },
  { id: 17, title: 'Auragen', description: 'AI content and creative generation platform for text, ideas, and multimedia assets.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'React'], liveUrl: 'https://auragen-ojrl2hkv2-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/auragen', featured: false, gradient: 'from-yellow-500 to-orange-800' },
  { id: 18, title: 'Starmind', description: 'AI-driven knowledge graph and idea connection platform for researchers and thinkers.', category: 'AI/ML', techStack: ['Next.js', 'React', 'Graph'], liveUrl: 'https://starmind-ptyz666t4-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/starmind', featured: false, gradient: 'from-violet-500 to-purple-800' },
  { id: 19, title: 'Startup Idea Generator', description: 'AI-powered startup idea generator with market analysis and validation framework.', category: 'AI/ML', techStack: ['HTML', 'JavaScript'], liveUrl: 'https://startup-idea-generator-u5jeh4175-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/startup-idea-generator', featured: false, gradient: 'from-green-500 to-emerald-800' },
  ...
  // === EDUCATION ===
  { id: 23, title: 'Ontario G1 Test Bank', description: 'Comprehensive practice question bank for the Ontario G1 driving knowledge test.', category: 'Education', techStack: ['Next.js', 'TypeScript', 'React'], liveUrl: null, sourceUrl: 'https://github.com/igor-kan/ontario-g1-test-bank', featured: false, gradient: 'from-blue-600 to-blue-900' },
  { id: 24, title: 'Home STEM Spark', description: 'Interactive STEM learning activities and experiments designed for home education.', category: 'Education', techStack: ['Next.js', 'React', 'Tailwind'], liveUrl: 'https://home-stem-spark-bk9wrszsq-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/home-stem-spark', featured: false, gradient: 'from-orange-500 to-red-800' },
  { id: 25, title: 'Scientia', description: 'Science learning platform with curated content, quizzes, and concept mapping.', category: 'Education', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://scientia-17unvb46o-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/scientia', featured: false, gradient: 'from-teal-600 to-green-900' },
  { id: 26, title: 'Pronunciation Guide', description: 'Interactive phonetics and pronunciation training tool with IPA reference.', category: 'Education', techStack: ['Next.js', 'React', 'Audio'], liveUrl: 'https://pronunciation-guide-9az92zomq-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/pronunciation-guide', featured: false, gradient: 'from-cyan-600 to-blue-900' },
  ...
  // === FINANCE ===
  { id: 30, title: 'Finsage', description: 'Personal finance tracking and budgeting app with AI-powered spending insights.', category: 'Finance', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://finsage-2foalyth5-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/finsage', featured: false, gradient: 'from-green-600 to-teal-900' },
  ...
  { id: 32, title: 'Algofund', description: 'Algorithmic trading and investment strategy backtesting platform.', category: 'Finance', techStack: ['Next.js', 'Python', 'React'], liveUrl: 'https://igor-kan.github.io/algofund/', sourceUrl: 'https://github.com/igor-kan/algofund', featured: false, gradient: 'from-blue-600 to-cyan-900' },
  { id: 33, title: 'Invoice Maker', description: 'Clean, fast invoice generator with PDF export and client management.', category: 'Finance', techStack: ['HTML', 'JavaScript', 'CSS'], liveUrl: 'https://invoice-maker-gkqg0pxsc-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/invoice-maker', featured: false, gradient: 'from-slate-600 to-gray-900' },
  ...
  { id: 35, title: 'Bloomwell', description: 'Mental wellbeing and mindfulness tracking app with mood journaling and guided exercises.', category: 'Health', techStack: ['React', 'Vite', 'Tailwind'], liveUrl: 'https://bloomwell-i9jine7k7-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/bloomwell', featured: false, gradient: 'from-pink-500 to-rose-800' },
  { id: 36, title: 'Bloom Web Project', description: 'Modern web application template with full design system and component library.', category: 'Web Dev', techStack: ['Next.js', 'shadcn/ui', 'TypeScript'], liveUrl: 'https://bloom-web-project-cdg03t8dl-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/bloom-web-project', featured: false, gradient: 'from-fuchsia-600 to-purple-900' },
  ...
  { id: 38, title: 'ForgeFlow', description: 'Workflow automation and process management platform for developers and teams.', category: 'Web Dev', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://forgeflow-okg6nu7b7-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/forgeflow', featured: false, gradient: 'from-orange-600 to-red-900' },
  ...
  { id: 41, title: 'Sapien Data Labeling', description: 'Human-in-the-loop data labeling and annotation platform for ML training datasets.', category: 'AI/ML', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://sapien-data-labeling-m0ldy18rv-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/sapien-data-labeling', featured: false, gradient: 'from-cyan-600 to-teal-900' },
  { id: 42, title: 'Mind Forge', description: 'Mental model builder and cognitive framework visualization tool for critical thinking.', category: 'Web Dev', techStack: ['Next.js', 'React', 'D3.js'], liveUrl: 'https://mind-forge-bdebw22fu-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/mind-forge', featured: false, gradient: 'from-indigo-600 to-violet-900' },
  { id: 43, title: 'NutraForge', description: 'Personalized nutrition planning and meal optimization platform with macro tracking.', category: 'Health', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://nutraforge-ojcd3s7b2-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/nutraforge', featured: false, gradient: 'from-lime-600 to-green-900' },
  { id: 44, title: 'UI Art Gallery', description: 'Curated gallery of UI design patterns, components, and creative web experiences.', category: 'Web Dev', techStack: ['Next.js', 'React', 'Tailwind'], liveUrl: 'https://ui-art-gallery-ogbk1vhwq-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/ui-art-gallery', featured: false, gradient: 'from-rose-600 to-pink-900' },
  { id: 45, title: 'Univera', description: 'University resource aggregation and campus life management platform for students.', category: 'Education', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://univera-5oyo63i51-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/univera', featured: false, gradient: 'from-blue-600 to-sky-900' },
  { id: 46, title: 'Lexisuite', description: 'Advanced lexical analysis and vocabulary management suite for writers and linguists.', category: 'Web Dev', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://lexisuite-6o5f01xt3-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/lexisuite', featured: false, gradient: 'from-amber-600 to-orange-900' },
  { id: 47, title: 'Textcast', description: 'Text-to-audio broadcasting platform that converts written content to listenable podcasts.', category: 'Web Dev', techStack: ['Next.js', 'React', 'Web Audio'], liveUrl: 'https://textcast-834cnrweh-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/textcast', featured: false, gradient: 'from-purple-600 to-indigo-900' },
  { id: 48, title: 'WingmanAI', description: 'AI-powered networking and communication assistant for professional relationship building.', category: 'AI/ML', techStack: ['Next.js', 'AI', 'TypeScript'], liveUrl: 'https://wingmanai-7j4al383n-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/wingmanai', featured: false, gradient: 'from-sky-600 to-indigo-900' },
  { id: 49, title: 'Eats Nearby', description: 'Local restaurant discovery and food recommendation app with personalized suggestions.', category: 'Web Dev', techStack: ['Next.js', 'React', 'Maps'], liveUrl: 'https://eats-nearby-finds-jxbquaxdk-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/eats-nearby-finds', featured: false, gradient: 'from-orange-600 to-yellow-900' },
  { id: 50, title: 'GPS Art Runner', description: 'Running route designer that creates GPS art patterns visible on mapping platforms.', category: 'Web Dev', techStack: ['Next.js', 'Maps API', 'React'], liveUrl: 'https://gps-art-runner-w56zjx3y5-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/gps-art-runner', featured: false, gradient: 'from-teal-600 to-cyan-900' },
  { id: 51, title: 'Bond', description: 'Relationship and connection tracking app for maintaining meaningful personal networks.', category: 'Web Dev', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://bond-b4wppt40m-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/bond', featured: false, gradient: 'from-rose-600 to-red-900' },
  { id: 52, title: 'Compass', description: 'Life goal tracking and direction-setting app with milestone management and reflection tools.', category: 'Web Dev', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://compass-kv251kopo-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/compass', featured: false, gradient: 'from-blue-600 to-teal-900' },

  // === TOOLS & UTILITIES ===
  { id: 53, title: 'Unit Converter', description: 'Fast, comprehensive unit conversion tool covering length, mass, temperature, energy, and more.', category: 'Tools', techStack: ['HTML', 'JavaScript', 'CSS'], liveUrl: 'https://unit-converter-65c2b4lto-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/unit-converter', featured: false, gradient: 'from-slate-500 to-gray-800' },
  { id: 54, title: 'Text Case Converter', description: 'Multi-mode text case transformer: camelCase, snake_case, CONSTANT, Title Case, and more.', category: 'Tools', techStack: ['HTML', 'JavaScript'], liveUrl: 'https://text-case-converter-3ru90y2b7-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/text-case-converter', featured: false, gradient: 'from-zinc-500 to-slate-800' },
  { id: 55, title: 'Text Diff Checker', description: 'Side-by-side text comparison tool with highlighted diff visualization.', category: 'Tools', techStack: ['HTML', 'JavaScript'], liveUrl: 'https://text-diff-checker-gxf1wxyoi-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/text-diff-checker', featured: false, gradient: 'from-neutral-500 to-stone-800' },
  { id: 56, title: 'QR Code Bulk Generator', description: 'Batch QR code generator for URLs, contacts, and custom data with download options.', category: 'Tools', techStack: ['HTML', 'JavaScript', 'Canvas'], liveUrl: 'https://qr-code-bulk-generator-9kdcl8uh7-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/qr-code-bulk-generator', featured: false, gradient: 'from-gray-600 to-zinc-900' },
  { id: 57, title: 'Meme Maker', description: 'Quick meme creation tool with template library and custom text overlay.', category: 'Tools', techStack: ['HTML', 'JavaScript', 'Canvas'], liveUrl: 'https://meme-maker-1xcold6l6-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/meme-maker', featured: false, gradient: 'from-yellow-500 to-amber-800' },
  { id: 58, title: 'Simple Todo App', description: 'Minimal, fast task manager with local persistence and priority sorting.', category: 'Tools', techStack: ['HTML', 'JavaScript', 'CSS'], liveUrl: 'https://simple-todo-app-v1-4b7s915dm-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/simple-todo-app-v1', featured: false, gradient: 'from-blue-500 to-sky-800' },
  { id: 59, title: 'Random Quote Generator', description: 'Inspirational quote generator with category filtering and social sharing.', category: 'Tools', techStack: ['HTML', 'JavaScript'], liveUrl: 'https://random-quote-generator-ez6ly3105-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/random-quote-generator', featured: false, gradient: 'from-violet-500 to-purple-800' },
  { id: 60, title: 'Timezone Meeting Planner', description: 'Multi-timezone meeting scheduler that finds optimal overlap times for global teams.', category: 'Tools', techStack: ['HTML', 'JavaScript'], liveUrl: 'https://timezone-meeting-planner-8001efrcw-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/timezone-meeting-planner', featured: false, gradient: 'from-teal-500 to-cyan-800' },
  { id: 61, title: 'Word Reverser Game', description: 'Fun word puzzle game with timed challenges and leaderboard.', category: 'Tools', techStack: ['HTML', 'JavaScript'], liveUrl: 'https://word-reverser-game-r7c3tgonf-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/word-reverser-game', featured: false, gradient: 'from-pink-500 to-rose-800' },
  { id: 62, title: 'Color Palette Generator', description: 'Aesthetic color palette generator with export options for design tools.', category: 'Tools', techStack: ['HTML', 'JavaScript', 'CSS'], liveUrl: 'https://color-palette-generator-54zq2v69n-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/color-palette-generator', featured: false, gradient: 'from-rainbow-gradient rainbow-gradient', },
  ...
  { id: 73, title: 'Spark', description: 'Creative inspiration and project kickstarter platform for developers and designers.', category: 'Web Dev', techStack: ['Next.js', 'React', 'TypeScript'], liveUrl: 'https://spark-7eqxot0yb-igorkan010-8748s-projects.vercel.app', sourceUrl: 'https://github.com/igor-kan/spark', featured: false, gradient: 'from-yellow-600 to-orange-900' },
